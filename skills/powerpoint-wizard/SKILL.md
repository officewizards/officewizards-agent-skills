...
description: Control Microsoft PowerPoint desktop for Windows through the PowerPoint Wizard npx CLI. Use when an agent needs to inspect PowerPoint, list/open/close presentations, read slides and shapes, export PDF or images, run macros or temporary VBA, or automate PowerPoint without browser automation, Microsoft Graph, Office.js add-ins, or raw PowerShell-first workflows.
